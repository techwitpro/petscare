...
export default function About() {
    return (
        <div id="about" className="bg-white">
            <div className="max-w-7xl mx-auto py-20 px-4 flex flex-col-reverse lg:flex-row justify-between">
                <img className="w-2/3 lg:w-2/5 h-auto mx-auto" src="./Images/sectionImage/Bringing.png" alt="" />
                <div className="lg:w-3/5 lg:pl-10">
                    <h1 className="text-[#002935] text-[34px] md:text-[45px] font-semibold mb-7 leading-[50px]">Bringing a Independence To little Closer to Home.</h1>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between">
                        ...
                        <img className="w-2/5 xl:w-1/2" src="./Images/sectionImage/Bringing-dog.png" alt="" />
                    </div>
